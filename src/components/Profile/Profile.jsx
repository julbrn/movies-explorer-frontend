          ...
          <form name="edit" className="profile__form" onSubmit={handleSubmit}>
            <fieldset className="profile__fields">
              ...
              <label className="profile__label">
                ...
                />
                <span className="profile__field-error">
                  {errors.name
            ...
            <div className="profile__server-responses">
              <span
                className={`profile__server-response ${
                  isServerResponseVisible
                    ? "profile__server-response_success"
                    : ""
                }`}
              >
              ...
              <span
                className={`profile__server-response ${
                  errorMessage.message ? "profile__server-response_failure" : ""
                }`}
              >
                {errorMessage.message}
              </span>
